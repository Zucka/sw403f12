...
With the Internet getting faster and faster, more users are online, which does not limit the users possibility when they can compile the slideshow. Although the compiler can be downloaded for offline use if needed.
