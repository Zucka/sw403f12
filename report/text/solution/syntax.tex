...
\#, *, 
@font\_type, @font\_color, @font\_size, @font\_weight, @u, @i, @b, 
...
\begin{lstlisting}[frame=single]
Input: @image{@url: http://www.danwec.com/images/foto/thumbs3/aau\_logo.jpg  \| Aalborg University logo}

Output:
(An image from the webpage http://www.danwec.com/images/foto/thumbs3/aau\_logo.jpg is shown  with the image description of ``Aalborg University logo’’)
\end{lstlisting}
