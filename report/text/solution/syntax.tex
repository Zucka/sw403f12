...
\noindent{\texttt{Output: Hello and welcome (in title format with size 70)}} \\
...
\noindent{\texttt{Output: Welcome to this slide (with font size 25)}} \\
...
\noindent{\texttt{Output: \textbf{Welcome to bold text} (with font size 25)}} \\
...
\noindent{\texttt{Output: \textbf{Welcome to bold text}}} \\
...
\noindent{\texttt{Output: \textbf{Welcome to \underline{bold} text}}} \\
...
Where a \texttt{\#} symbolises a number that incrementing. By using two \texttt{\#} creates a sub numeration starting from one.
