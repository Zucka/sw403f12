...
Line 4 finds out which class the setting block belongs to. This is necessary to determin if the setting block is inside or outside a slide. Which also is the first to be checked in line 5. An else construction is made for this if sentence which is executed when the setting should be applied on very upcomming slide.\\
