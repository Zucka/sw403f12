...
%The token list is then given to the parser, which is building a parse tree, also called an abstract syntax tree (AST), constructed from a context-free grammar. 
