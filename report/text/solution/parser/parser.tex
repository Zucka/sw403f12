...
\section{Conclusion}
The CFG is concluded to be LL(1) according to the section \ref{Parserstrategy}, the CFG is not ambiguous either, as per the definition of LL(1).(\cite{CaC} Chapter 5.1)
