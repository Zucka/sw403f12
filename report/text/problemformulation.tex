...
Furthermore, how can you display the presentation in a way so that it will look the same on all devices, while still being usable on all devices? \\
...
%A challenge regarding creating a suitable domain specific language with weight on consistency and simplicity to enable the user to focus on the content rather than the layout.
\\ \\
