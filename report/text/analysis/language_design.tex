...
\noindent{In table \ref{tbl:evaluation criteria result} the language design criteria that has been prioritized
for the programming language design for this project are listed.}
\begin{table}[htbp]
\centering
\begin{tabular}{|l|c|c|c|c|}
\hline
