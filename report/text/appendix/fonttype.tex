...
CSS 3 has inherited it extended color keywords from SVG, which is the colors that can be used in NISSE \cite{W3}. An example of the use of changing the font color is shown in listing \ref{lst:AFontColor}.
