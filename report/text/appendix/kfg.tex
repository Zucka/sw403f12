...
\section{kfG}
\label{AkfG}
Listing \ref{lst:akfG} is the settings used in the program ``kfG Edit'', to be able to write AST examples of the defined language.
\begin{lstlisting}[frame=single, caption=kfG grammer for the language, label=lst:akfG]
SS           -> Blocks 
