...
public final class AQuantifiedexprPart extends PQuantifiedexprPart
{
    ...
    public Object clone()
    {
        return new AQuantifiedexprPart(
    ...
    {
        ((Analysis) sw).caseAQuantifiedexprPart(this);
    }
