...
public final class ATexttest extends PTexttest
{
    private TFnText _fnText_;
    ...
    public ATexttest(
        @SuppressWarnings("hiding") TFnText _fnText_,
    ...
    public Object clone()
    {
        return new ATexttest(
            cloneNode(this._fnText_),
    ...
    {
        ((Analysis) sw).caseATexttest(this);
    }

    public TFnText getFnText()
    {
        return this._fnText_;
    }

    public void setFnText(TFnText node)
    {
        if(this._fnText_ != null)
        {
            this._fnText_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._fnText_ == oldChild)
        {
            setFnText((TFnText) newChild);
            return;
        }
