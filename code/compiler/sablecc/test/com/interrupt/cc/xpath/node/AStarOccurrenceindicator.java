...
public final class AStarOccurrenceindicator extends POccurrenceindicator
{
    private TStar _star_;

    public AStarOccurrenceindicator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStarOccurrenceindicator(
            cloneNode(this._star_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAStarOccurrenceindicator(this);
    }
