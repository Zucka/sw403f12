...
public final class AStarAttribnameorwildcard extends PAttribnameorwildcard
{
    private TStar _star_;

    public AStarAttribnameorwildcard()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStarAttribnameorwildcard(
            cloneNode(this._star_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAStarAttribnameorwildcard(this);
    }
