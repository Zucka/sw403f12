...
public final class ACommenttest extends PCommenttest
{
    private TFnComment _fnComment_;
    ...
    public Object clone()
    {
        return new ACommenttest(
            cloneNode(this._fnComment_),
    ...
    {
        ((Analysis) sw).caseACommenttest(this);
    }

    public TFnComment getFnComment()
    {
        return this._fnComment_;
    }

    public void setFnComment(TFnComment node)
    {
        if(this._fnComment_ != null)
        {
            this._fnComment_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._fnComment_ == child)
        {
            this._fnComment_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._fnComment_ == oldChild)
        {
            setFnComment((TFnComment) newChild);
            return;
        }
