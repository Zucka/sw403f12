...
public final class AFunctioncallPartPart extends PFunctioncallPartPart
{
    private TComma _comma_;
    private PExprsingle _exprsingle_;

    public AFunctioncallPartPart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctioncallPartPart(
    ...
    {
        ((Analysis) sw).caseAFunctioncallPartPart(this);
    }
