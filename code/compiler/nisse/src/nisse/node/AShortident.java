...
public final class AShortident extends PShortident
{
    ...
    private final LinkedList<PShortidentv1> _shortidentv1_ = new LinkedList<PShortidentv1>();
    ...
    public AShortident(
        ...
        @SuppressWarnings("hiding") List<PShortidentv1> _shortidentv1_,
    ...
    public LinkedList<PShortidentv1> getShortidentv1()
    {
        return this._shortidentv1_;
    }

    public void setShortidentv1(List<PShortidentv1> list)
    {
        this._shortidentv1_.clear();
        this._shortidentv1_.addAll(list);
        for(PShortidentv1 e : list)
        {
            if(e.parent() != null)
            {
                e.parent().removeChild(e);
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._shortidentv1_.remove(child))
        {
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PShortidentv1> i = this._shortidentv1_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
                {
                    i.set((PShortidentv1) newChild);
                    newChild.parent(this);
                    oldChild.parent(null);
                    return;
                }
