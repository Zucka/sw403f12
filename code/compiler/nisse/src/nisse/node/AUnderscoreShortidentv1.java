...
public final class AUnderscoreShortidentv1 extends PShortidentv1
{
    private TUnderscore _underscore_;

    public AUnderscoreShortidentv1()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnderscoreShortidentv1(
            cloneNode(this._underscore_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAUnderscoreShortidentv1(this);
    }
