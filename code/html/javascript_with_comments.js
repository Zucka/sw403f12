$(function(){
	...
	function findHHandWW(imgEle, newImg, sType) {
		...
		switch (hS){
			case 1:{
				imgHeight = (new_height*0.30);
				break;
			};
			case 2:{
				imgHeight = (new_height*0.54);
				break;
			};
			case 3:{
				imgHeight = (new_height*0.77);
				break;
			};
		};
		...
		switch (wS){
			case 1:{
				if (imgWidth > (new_width*0.20485175202)) {
					imgWidth = (new_width*0.20485175202);
				} 
				break;
			};
			case 2:{
				if (imgWidth > (new_width*0.26819407008)) {
					imgWidth = (new_width*0.26819407008);
				} 
				break;
			};
			case 3:{
				if (imgWidth > (new_width*0.3935309973)) {
					imgWidth = (new_width*0.3935309973);
				} 
				break;
			};
			case 4:{
				if (imgWidth > (new_width*0.40970350404)) {
					imgWidth = (new_width*0.40970350404);
				} 
				break;
			};
			case 5:{
				if (imgWidth > (new_width*0.820754)) {
					imgWidth = (new_width*0.820754);
				} 
				break;
			};
		};
